...
import logo from '../assets/meblored_logo.png'
import logoFull from '../assets/meblored_logo_full.png'
...
const Sidebar = () => {
  ...
  const styles = {
    ...
    mebloredLogo: `mr-4 flex object-cover`,
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.companyName}>
        <Image src={logoFull} alt='meblored' height={150} width={300} />
      </div>
    </div>
  )
}
